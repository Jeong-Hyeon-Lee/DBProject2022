		...
		M_mangeClass.addActionListener(new ActionListener() {
			...
			public void actionPerformed(java.awt.event.ActionEvent e) {
				...
				try {
					...
					// Can manage classes only if the current member has a gym, a trainer, and
					// membership.
					if (rs_test.next()) {
						if (rs_test.getString(1) != null && rs_test.getString(2) != null
								&& !rs_test.getString(3).equals("없음")) {
