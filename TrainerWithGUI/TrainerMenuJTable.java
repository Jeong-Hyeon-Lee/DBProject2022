...
public class TrainerMenuJTable extends JFrame implements ActionListener {
	...
	String[] trainer_info = { "Trainer Number", "Trainer Name", "Trainer Gym", "Member No", "Class Time" }; // 트레이너 정보
																											// (로그인한
																											// 본인의) 정보를
																											// 보여주기 위한
																											// 테이블
	String[] class_info = { "Student Name", "Class Time", "Class Status", "Student Number" }; // 수업 정보 저장을 위한 테이블 (트레이너
																								// 화면의 메인 부분에는 트레이너의 모든
																								// 수업이 포함되어 있다.)
